...
It's really important to start this conversation early because:
...
2. One important factor that affects whether you're granted a promotion and corresponding raise is your company's budget. **Budget discussions generally happen much earlier in the annual cycle than performance reviews**, so planting the idea in your manager's head early can help to ensure that your raise is incorporated into the upcoming budget. (As an example, at my company the budget is set NINE MONTHS before raises and promotions go into effect.)
